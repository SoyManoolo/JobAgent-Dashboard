...
- Separación entre ofertas activas y páginas independientes para candidaturas aplicadas y descartadas.
...
├── pages/descartadas.astro          # Archivo de ofertas descartadas
